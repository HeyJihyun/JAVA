...
public class HomeworkMain01 {
    public static void main(String[] args) {
         ...
         * 
         * if(memberIdx == -1) { System.out.println("입력하신 [" + id+ "]는 존재하지 않습니다.");
         * System.out.println("서비스를 종료합니다."); System.exit(0); }
         * 
         * 
         * 
         * System.out.print("현재 패스워드를 입력하세요 : "); String password = sc.nextLine();
         * if(!members.get(memberIdx).getPassword().equals(password)) {
         * System.out.println("입력한 패스워드가 올바르지 않습니다.");
         * System.out.println("서비스를 종료합니다."); System.exit(0); }
         * System.out.print("변경할 새로운 패스워드를 입력하세요 : "); String newPassword =
         * sc.nextLine(); members.get(memberIdx).setPassword(newPassword);
         * System.out.println("패스워드 변경이 완료되었습니다.");
         * 
         * System.out.println("< 전체 회원 목록 >");
         * System.out.println("--------------------"); System.out.println("아이디\t패스워드");
         * System.out.println("--------------------");
         * 
         * for(Member m : members) { System.out.println(m.getId() + "\t" +
